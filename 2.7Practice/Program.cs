...
namespace _2._7Practice
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string textPointsSum = "Sum of all points ";
            Console.WriteLine(textPointsSum + pointsSum);
            Console.ReadKey();
            double pointsArithmeticMeans = pointsSum / 3;
            string textPointsArithmeticMeansSum = "Arithmetic Means of all points ";
            Console.WriteLine(textPointsArithmeticMeansSum + pointsArithmeticMeans);
            Console.ReadKey();
